  # -*- coding: utf-8 -*-
  # Run this program in Abaqus to parameterize STL generation
from abaqus import *
...
a.Instance(name='origin-1', part=p, dependent=ON)
  # Create 8 corner points and edges
a = mdb.models['Model-1'].rootAssembly
...
p1 = mdb.models['Model-1'].parts['fcc_cell']
  # Create sketch plane for cutting
...
s.unsetPrimaryObject()
del mdb.models['Model-1'].sketches['__profile__']
  # Draw cutting profile and perform Cut 2
p = mdb.models['Model-1'].parts['fcc_cell']
f1, e1, d2 = p.faces, p.edges, p.datums
...
a1.LinearInstancePattern(instanceList=('fcc_cell-1', ), direction1=(1.0, 0.0,
    0.0), direction2=(0.0, 1.0, 0.0), number1=8, number2=2, spacing1=8.0,
    spacing2=8.0)
  # Array 2
a1 = mdb.models['Model-1'].rootAssembly
a1.LinearInstancePattern(instanceList=('fcc_cell-1', 'fcc_cell-1-lin-1-2',
    'fcc_cell-1-lin-2-1', 'fcc_cell-1-lin-2-2', 'fcc_cell-1-lin-3-1',
    'fcc_cell-1-lin-3-2', 'fcc_cell-1-lin-4-1', 'fcc_cell-1-lin-4-2',
    'fcc_cell-1-lin-5-1', 'fcc_cell-1-lin-5-2', 'fcc_cell-1-lin-6-1',
    'fcc_cell-1-lin-6-2', 'fcc_cell-1-lin-7-1', 'fcc_cell-1-lin-7-2',
    'fcc_cell-1-lin-8-1', 'fcc_cell-1-lin-8-2'), direction1=(1.0, 0.0, 0.0),
    direction2=(0.0, 0.0, 1.0), number1=1, number2=2, spacing1=64.0,
    spacing2=8.0)
